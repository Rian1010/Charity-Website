...
/*
    ...
    var unemp_rate_year2_dim = ndx.dimension(dc.pluck('femaleUnempRateMZ')),
        femaleUnempRateMZ = unemp_rate_year_dim.group().reduceCount(dc.pluck('MZ'));

    var unemp_rate_year3_dim = ndx.dimension(dc.pluck('femaleUnempRateUG')),
    ...
    composite
        ...
        .compose([
            ...
            .dashStyle([2, 2]),
            dc.lineChart(composite)
            .dimension(unemp_rate_year2_dim)
            .colors('blue')
            .group(femaleUnempRateMZ, "MZ")
            .dashStyle([5, 5]),
            dc.lineChart(composite)
            .dimension(unemp_rate_year3_dim)
            .colors('grey')
            .group(femaleUnempRateUG, "UG")
            .dashStyle([8, 8])
        ])
